...
// IsCollectServiceClient is the client API for IsCollectService service.
//
...
func NewIsCollectServiceClient(cc grpc.ClientConnInterface) IsCollectServiceClient {
...
// IsCollectServiceServer is the server API for IsCollectService service.
...
// UnimplementedIsCollectServiceServer must be embedded to have forward compatible implementations.
...
// UnsafeIsCollectServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to IsCollectServiceServer will
// result in compilation errors.
type UnsafeIsCollectServiceServer interface {
	mustEmbedUnimplementedIsCollectServiceServer()
}

func RegisterIsCollectServiceServer(s grpc.ServiceRegistrar, srv IsCollectServiceServer) {
...
// IsCollectService_ServiceDesc is the grpc.ServiceDesc for IsCollectService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var IsCollectService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc.IsCollectService",
	...
	Metadata: "app/grpc/proto/iscollect/iscollect.proto",
}
